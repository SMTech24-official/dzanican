        ...
        <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
            <div className="text-center space-y-6">
                ...
                <div className="pt-[10px] pb-[20px] w-[450px] text-left">
                    <label htmlFor="username" className="text-[14px] pb-2">Enter your Username</label><br/>
                    <input id="username" className="w-full mt-3 border py-[11px] px-[16px] text-[#BDC3C7]" placeholder="Enter Username" />
                </div>
